...
* (개인프로젝트) `시간관리 커뮤니티` 1기 발표 준비
  * 목적 : 
    ...
    * 6개월 동안 작성한 글을 기반으로 강연 1회 이상 해보는 목표를 가지고 있는데 [`1분기 회고글`](https://velog.io/@h-go-getter/%EC%97%B4%EC%A0%95%EC%A0%81%EC%9D%B8-%EC%82%AC%EB%9E%8C%EC%9D%98-2023%EB%85%84-1%EB%B6%84%EA%B8%B0-%ED%9A%8C%EA%B3%A0) 내요을 기반으로 발표하려고 함
  * 내용 : 발표자료 준비
