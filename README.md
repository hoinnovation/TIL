...
* `데이터 분석가` 동료와 커피드백 진행 
  * 목적 : 글또 8기 글 피드백
  * 배운 점 : 
    * 평소에 가독성과 글 흐름이 좋다고 생각했던 분과 커피드백을 진행했다. 글을 쓸 때 했던 고민들을 많이 질문드렸는데, 정말 자세하게 답변을 주셔서 감사했다. 이런 분들을 만나서 함께 글에 대한 이야기를 나눌 수 있어서 참 좋다. 트레바리 모임을 할 떄 글을 짧고 핵심만 담아서 잘 쓴다는 피드백을 받았었는데, 왠지모르게 기술 블로그 글은 문장이 길어지는 것 같다. 다음 모글은 짧게 쓰려고 해봐야지!! 오늘도 많이 배우고 액션플랜도 얻을 수 있어 의미 있었다. 꼭 적용까지 연결해봐야겠다.
