...
* [생산성을 높이는 방법](https://blog.naver.com/bizucafe/223021774397)을 읽고
  * 느낀 점 : 링크드인에서 이 블로그를 알게 되어, 해당 글을 읽었는데 좋은 에너지를 많이 받았다. 제일 충격적이었던 것은 "모든 일을 전부 다 하려고 하세요"였다. 일의 가짓 수를 줄이고 집중해야한다는 말을 들어왔고, 그게 맞다고 생각했는데 생각이 깨졌다. 글을 통해 얻은 인사이트를 글로 써둬야지!
