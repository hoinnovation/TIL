...
* (커피챗) `PM을 위한 데이터리터러시` 강의 듣고 하는 모임 참여
 ...
 * (개인 스터디) PM을 위한 데이터 리터러시(프러덕트 데이터 분석) 로그 설계 part 문제 풀기
    * 목적 :  데이터 기반 제품 개발 프로세스 경험, 업무에 활용
 ...
 * (개인 스터디) PM을 위한 데이터 리터러시(프러덕트 데이터 분석) 강의 듣기 - 로그 설계 part
    * 목적 :  데이터 기반 제품 개발 프로세스 경험, 업무에 활용
...
* (업무) [퇴근 후, 문자열 유사성 알고리즘 적용해서 업무 개선해보기](https://velog.io/@h-go-getter/%ED%87%B4%EA%B7%BC-%ED%9B%84-%EB%AC%B8%EC%9E%90%EC%97%B4-%EC%9C%A0%EC%82%AC%EC%84%B1-%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98-%EC%A0%81%EC%9A%A9%ED%95%B4%EC%84%9C-%EC%97%85%EB%AC%B4-%EA%B0%9C%EC%84%A0%ED%95%B4%EB%B3%B4%EA%B8%B0) 업로드
  * 목적 : 업무 활용, 글또 글 업로드
